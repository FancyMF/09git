...
- (void)layoutAnimatedLayer {
    ...
    imageView.frame = CGRectMake(0, 0, CGRectGetWidth(self.frame)/2, CGRectGetHeight(self.frame)/2);
...
-(UIImageView *)showImageView{
    if (!_showImageView) {
        UIImageView * imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"qry_subl_07"]];
